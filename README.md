...
Lowbase high risk
node dist/scripts/run-orchestrator.js --days 90 --combo 15,high,30 --no-events --log-file run.log
Mid growth High risk
node dist/scripts/run-orchestrator.js --days 90 --combo 60,high,10 --no-events --log-file run.log
