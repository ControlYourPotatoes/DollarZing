...
Lowbase high risk
node dist/scripts/run-orchestrator.js --days 90 --combo 15,mid,30 --no-events --log-file Lowrun.log
Mid growth High risk
node dist/scripts/run-orchestrator.js --days 90 --combo 35,mid,30 --no-events --log-file Midrun.log
High
node dist/scripts/run-orchestrator.js --days 90 --combo 60,mid,30 --no-events --log-file Highrun.log
