...
import { createEmptyRevenueStream } from './virtual-dollar-engine';
/**
...
export class RevenueCalculator {
    ...
    platformFeePerPlayer = 0.10; // 10 cents per player
    totalPlayersPerGame = 2; // Always 2 players in 1v1 games
    cashOutCount = 0; // Track cash-out count separately
    constructor(initialCharityPercentage = 0.15) {
     ...
     */
    processGameRevenue(gameSession) {
        try {
     ...
     */
    processCashOut(progressionAmount) {
        try {
            // Validate inputs
