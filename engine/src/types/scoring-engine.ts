...
export class ScoringEngine {
   ...
   */
  private normalizeScore(hash: number): number {
   ...
   */
  private validateSerialNumber(serialNumber: string): ValidationResult {
    const errors: string[] = [];
   ...
   */
  private validateDailySeed(dailySeed: string): ValidationResult {
    const errors: string[] = [];
   ...
   */
  private getCacheKey(serialNumber: string, dailySeed: string): string {
