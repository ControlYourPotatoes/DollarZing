...
class DataGenerationWorkerWrapper {
    ...
    async initialize() {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.worker = new global.Worker('/workers/data-generation-worker.js');
    ...
    async generateDataset(parameters, onProgress) {
        if (!this.worker) {
...
describe('Data Generation Worker', () => {
    ...
    describe('Worker Communication Protocol', () => {
        ...
        it('should handle progress updates during generation', async () => {
            ...
            const generationPromise = workerWrapper.generateDataset({ duration: 365 }, (progress) => progressUpdates.push(progress));
    ...
    describe('Error Handling and Recovery', () => {
        ...
        it('should handle worker runtime errors', async () => {
            ...
            const errorEvent = new global.ErrorEvent('error', {
        ...
        it('should handle worker message errors', async () => {
            ...
            const messageErrorEvent = new global.MessageEvent('messageerror', {
...
//# sourceMappingURL=data-generation-worker.test.js.map