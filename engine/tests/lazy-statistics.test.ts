...
describe('Lazy Statistics Manager', () => {
  ...
  describe('Game Statistics Calculation', () => {
    it('should calculate complex game statistics correctly', () => {
      ...
      console.log(`Complex game statistics calculated in ${(endTime - startTime).toFixed(2)}ms`);
    });
    ...
    it('should recalculate when cache is invalidated', async () => {
      ...
      expect(stats2.lastUpdated.getTime()).toBeGreaterThanOrEqual(stats1.lastUpdated.getTime());
  ...
  describe('Player Statistics Calculation', () => {
    it('should calculate complex player statistics correctly', () => {
      ...
      expect(stats.activePlayers + stats.retiredPlayers).toBeLessThanOrEqual(stats.totalPlayers);
      ...
      console.log(`Complex player statistics calculated in ${(endTime - startTime).toFixed(2)}ms`);
    });
  ...
  describe('Performance Optimization', () => {
    it('should provide significant performance improvement with caching', () => {
      ...
      console.log(`Performance improvement: ${(uncachedTime / cachedTime).toFixed(1)}x`);
    });
    ...
    it('should track performance statistics', () => {
      ...
      expect(perfStats.operationStats.playerStats?.totalCalls).toBeGreaterThan(0);
      expect(perfStats.operationStats.gameStats?.averageTime).toBeGreaterThan(0);
    ...
    it('should handle cache expiration', () => {
      ...
      return new Promise<void>((resolve) => {
        setTimeout(() => {
          ...
          expect(stats2.lastUpdated.getTime()).toBeGreaterThan(stats1.lastUpdated.getTime());
          resolve();
