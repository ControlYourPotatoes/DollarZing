...
describe('VirtualDollarManager', () => {
    ...
    describe('Dollar Creation', () => {
        ...
        it('should validate player IDs during creation', () => {
            ...
            expect(() => manager.createVirtualDollar(null)).toThrow('Invalid player ID');
            expect(() => manager.createVirtualDollar(undefined)).toThrow('Invalid player ID');
        });
    });
...
//# sourceMappingURL=virtual-dollar-manager.test.js.map