...
import { createEmptyRevenueStream } from '../src/types/virtual-dollar-engine';
...
describe('RevenueCalculator - Revenue Stream Separation', () => {
    describe('Revenue Category Tracking', () => {
        ...
        test('should maintain revenue stream consistency', () => {
            ...
            const calculatedTotal = mockRevenueData.platformRevenue +
...
describe('RevenueCalculator - Transaction Audit Trail', () => {
    describe('Transaction Recording', () => {
        ...
        test('should maintain balance consistency in transactions', () => {
            ...
            expect(gameFeeTransaction.expectedBalanceAfter.donationBalance).toBe(initialBalance.donationBalance - gameFeeTransaction.amount);
            expect(gameFeeTransaction.expectedBalanceAfter.winningsBalance).toBe(initialBalance.winningsBalance);
            expect(gameFeeTransaction.expectedBalanceAfter.currentProgression).toBe(initialBalance.currentProgression);
        });
    });
});
//# sourceMappingURL=revenue-calculator.test.js.map