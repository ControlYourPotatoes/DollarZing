...
import { SimulationController, SimulationConfig, SimulationProgress, SimulationResults } from '../src/types/simulation-controller';
  ...
  describe('Error Handling and Validation', () => {
    ...
    it('should provide meaningful error messages', () => {
      try {
        ...
        expect((error as Error).message).toContain('Duration must be at least 1 day');
      }
    });
  });
