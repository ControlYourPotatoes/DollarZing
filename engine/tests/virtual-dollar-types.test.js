...
import { DollarState, GameResult, CashOutDecision, validateSimulationParameters, createEmptyRevenueStream } from '../src/types/virtual-dollar-engine';
describe('Virtual Dollar Pool Game Engine - Type Definitions', () => {
    describe('VirtualDollar Interface', () => {
        test('should create valid VirtualDollar with all required properties', () => {
            const dollar = {
                id: 'dollar-123',
            ...
            expect(dollar.totalGamesPlayed).toBe(0);
            expect(dollar.totalWinnings).toBe(0);
            expect(dollar.totalLosses).toBe(0);
        });
        test('should validate serial number format', () => {
            const validSerials = ['L12345678A', 'Z98765432B', 'M00000001X'];
            const invalidSerials = ['12345678A', 'L1234567A', 'L123456789A', 'l12345678a'];
        ...
        test('should support all dollar states', () => {
            const states = [
                DollarState.CREATED,
                DollarState.POOLED,
                DollarState.IN_GAME,
    ...
    describe('GameSession Interface', () => {
        test('should create valid GameSession with comprehensive game data', () => {
            const dollar1 = createVirtualDollar('L11111111A', 'player1');
            const dollar2 = createVirtualDollar('L22222222B', 'player2');
            const gameSession = {
                id: 'game-789',
                dollar1,
                dollar2,
            ...
            expect(gameSession.platformFee).toBe(0.20);
    ...
    describe('Enums', () => {
        test('should define all required GameResult values', () => {
        ...
        test('should define all required CashOutDecision values', () => {
        ...
        test('should define all required DollarState values', () => {
    ...
    describe('RevenueStream Interface', () => {
        test('should create valid RevenueStream with separate revenue tracking', () => {
            const revenueStream = {
                platformClickRevenue: 100.00, // 500 games * $0.20
                charityContributions: 50.00, // 10% of cash-outs
                charityPercentage: 0.10,
                playerWinnings: 450.00,
                totalCashOuts: 500.00,
                totalGames: 500,
                totalClickFees: 100.00,
                averageCashOutAmount: 1.00
            };
            expect(revenueStream.platformClickRevenue).toBe(100.00);
            expect(revenueStream.charityContributions).toBe(50.00);
            expect(revenueStream.charityPercentage).toBe(0.10);
            expect(revenueStream.playerWinnings).toBe(450.00);
            expect(revenueStream.totalCashOuts).toBe(500.00);
            expect(revenueStream.totalGames).toBe(500);
            expect(revenueStream.totalClickFees).toBe(100.00);
            expect(revenueStream.averageCashOutAmount).toBe(1.00);
        });
    });
    describe('BettingLevel Validation', () => {
        test('should validate 11-level progression', () => {
    ...
    describe('SimulationParameters Interface', () => {
        test('should create valid SimulationParameters for game engine', () => {
            const params = {
                duration: 30, // 30 days
            ...
            expect(params.cashOutStrategyDistribution.conservative).toBe(0.40);
            expect(params.cashOutStrategyDistribution.balanced).toBe(0.40);
            expect(params.cashOutStrategyDistribution.aggressive).toBe(0.20);
        ...
        test('should validate parameter constraints', () => {
            const validParams = {
                ...
                initialPlayerCount: 1000,
                virtualDollarsPerPlayer: 5,
                cashOutStrategyDistribution: { conservative: 0.4, balanced: 0.4, aggressive: 0.2 },
                charityPercentage: 0.15,
    ...
    describe('MonthlySimulationResult Interface', () => {
        test('should create valid MonthlySimulationResult', () => {
            const result = {
                month: 1,
                ...
                gameStatistics: {
                    ...
                    levelDistribution: [10000, 5000, 2500, 1250, 625, 313, 156, 78, 39, 20, 10],
    ...
    describe('DailyGameReport Interface', () => {
        test('should create valid DailyGameReport', () => {
            const report = {
                day: 15,
    ...
    describe('Type Compilation', () => {
        test('should compile all types without errors', () => {
...
function createVirtualDollar(serialNumber, ownerId) {
    return {
...
//# sourceMappingURL=virtual-dollar-types.test.js.map