...
export function TimelineScrubber({
  ...
  return (
    <div className="fixed inset-x-0 bottom-[max(16px,env(safe-area-inset-bottom))] z-50 flex justify-center pointer-events-none">
      <div className="group pointer-events-auto relative w-full max-w-xl rounded-xl border border-slate-800/70 bg-slate-900/70 px-3 py-2 shadow-lg backdrop-blur-sm">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-between opacity-0 transition-opacity duration-150 group-hover:pointer-events-auto group-hover:opacity-100">
            <button
              ...
              className="inline-flex items-center justify-center p-1 text-slate-200 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500"
              onClick={() => {
